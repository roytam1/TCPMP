...
static int Create(subtitlex* p)
{
	...
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID ,NODE_NAME));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_FONTNAME));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_HIRESFONTSIZE));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_LOWRESFONTSIZE));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_LOWRESBOUNDARY));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_FONTBOLD));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_SPEED));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_OLDSTYLE));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_FPS));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_ENABLED));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_TOPALIGN));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_MARGINH));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_MARGINV));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_NOHIDE));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
	tcscpy_s(s,TSIZEOF(s),LangStr(SUBT_ID,SUBT_FONTCOLOR));
	StringAdd(1,SUBT_ID,NODE_NAME,_T(s));
