...
#define IF_OPTIONS_WHEEL				0x320
#define IF_OPTIONS_WHEEL_N				0x330
#define IF_OPTIONS_WHEEL_S				0x340
#define IF_OPTIONS_WHEEL_C				0x350

#define IF_OPTIONS_WHEEL_NONE			0x001
#define IF_OPTIONS_WHEEL_VOL			0x002
#define IF_OPTIONS_WHEEL_SEEK			0x003
#define IF_OPTIONS_WHEEL_ZOOM			0x004

#define IF_OPTIONS_WHEEL_N_NONE			IF_OPTIONS_WHEEL_N + IF_OPTIONS_WHEEL_NONE
#define IF_OPTIONS_WHEEL_S_NONE			IF_OPTIONS_WHEEL_S + IF_OPTIONS_WHEEL_NONE
#define IF_OPTIONS_WHEEL_C_NONE			IF_OPTIONS_WHEEL_C + IF_OPTIONS_WHEEL_NONE
#define IF_OPTIONS_WHEEL_N_VOL			IF_OPTIONS_WHEEL_N + IF_OPTIONS_WHEEL_VOL
#define IF_OPTIONS_WHEEL_S_VOL			IF_OPTIONS_WHEEL_S + IF_OPTIONS_WHEEL_VOL
#define IF_OPTIONS_WHEEL_C_VOL			IF_OPTIONS_WHEEL_C + IF_OPTIONS_WHEEL_VOL
#define IF_OPTIONS_WHEEL_N_SEEK			IF_OPTIONS_WHEEL_N + IF_OPTIONS_WHEEL_SEEK
#define IF_OPTIONS_WHEEL_S_SEEK			IF_OPTIONS_WHEEL_S + IF_OPTIONS_WHEEL_SEEK
#define IF_OPTIONS_WHEEL_C_SEEK			IF_OPTIONS_WHEEL_C + IF_OPTIONS_WHEEL_SEEK
#define IF_OPTIONS_WHEEL_N_ZOOM			IF_OPTIONS_WHEEL_N + IF_OPTIONS_WHEEL_ZOOM
#define IF_OPTIONS_WHEEL_S_ZOOM			IF_OPTIONS_WHEEL_S + IF_OPTIONS_WHEEL_ZOOM
#define IF_OPTIONS_WHEEL_C_ZOOM			IF_OPTIONS_WHEEL_C + IF_OPTIONS_WHEEL_ZOOM
...
#define IF_WHEEL_N						0x330
#define IF_WHEEL_S						0x331
#define IF_WHEEL_C						0x332
